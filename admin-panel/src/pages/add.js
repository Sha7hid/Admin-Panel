...
export default function Add() {
  // success is used to display the data is added successfully
  const [success, setSuccess] = useState(null);

  // the code in useEffect executes when the form is submitted and sending Post request to the api endpoint
  useEffect(() => {
